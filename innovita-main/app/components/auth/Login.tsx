            ...
            <div>
                ...
                <div className="flex items-center justify-center mt-1">
                    <button
                        ...
                        className="flex items-center justify-center w-full bg-blue-600 text-white text-[17px] font-semibold py-2 rounded-md hover:bg-blue-700 transition duration-200"
                        style={{ padding: "10px 0" }} 
                    >
                        <FaLinkedin className="mr-2" size={20} /> {/* Add LinkedIn logo */}
